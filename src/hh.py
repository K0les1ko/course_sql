        ...
        while True:
            ...
            for vacancy in hh_vacancies['items']:
                ...
                if vacancy['salary']['currency'] != 'RUR':
                    salary_min = int((salary_min * self.currency_rate[vacancy['salary']['currency']]['Value']) /
                                     self.currency_rate[vacancy['salary']['currency']]['Nominal'])
                    salary_max = int((salary_max * self.currency_rate[vacancy['salary']['currency']]['Value']) /
                                     self.currency_rate[vacancy['salary']['currency']]['Nominal'])
